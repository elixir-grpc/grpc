defmodule GRPC.StubCollisionTest do
  ...
  test "warn_on_collision option can suppress warnings" do
    # This test just verifies the option is accepted
    # The actual warning suppression was verified during compilation
    # (collision_test.pb.ex uses warn_on_collision: false)

    # If we got here without compilation errors, the option works
    assert true
  end
end
