...
defmodule Grpc.Testing.ScenarioResult do
  ...
  field(:client_stats, 3,
    repeated: true,
    type: Grpc.Testing.ClientStats,
    json_name: "clientStats"
  )

  field(:server_stats, 4,
    repeated: true,
    type: Grpc.Testing.ServerStats,
    json_name: "serverStats"
  )
