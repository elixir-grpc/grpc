defmodule GRPC.HTTP2.Frame.WindowUpdate do
  @moduledoc false
  ...
  def deserialize(_flags, _stream_id, _payload) do
    {:error, GRPC.HTTP2.Errors.frame_size_error(), "Invalid WINDOW_UPDATE frame (RFC9113§6.9)"}
  end

  defimpl GRPC.HTTP2.Frame.Serializable do
    def serialize(%GRPC.HTTP2.Frame.WindowUpdate{} = frame, _max_frame_size) do
